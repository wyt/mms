...
<div class="easyui-layout" fit="true">
	...
	<div region="west" border="false" split="true" style="width:150px;padding:5px;">
		<ul id="queryGood-t-types" url="<c:url value='/data/materialClass/getItems.mvc'/>"></ul>
	</div>
	<div region="center" border="false">
		<table id="queryGood-dt-goods" class="easyui-datagrid"
				url="<c:url value='/data/material/getItems.mvc'/>"
				fit="true" fitColumns="true" border="false" 
				pagination="true">
			<thead>
				<tr>
					<th field="ck" checkbox="true"></th>
					<th field="materialNo" width="80">物资编码</th>
					<th field="materialName" width="130">物资名称</th>
