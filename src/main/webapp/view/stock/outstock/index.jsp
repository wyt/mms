...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#dg-bills').billgrid({
				createUrl:'<c:url value="/stock/outStock/create"/>',
				editUrl:'<c:url value="/stock/outStock/edit"/>',
				destroyUrl:'<c:url value="/stock/outStock/destroy"/>',
				query:{
					title:'查询销售出库单',
					form:'<c:url value="/views/stock/outstock/_query.jsp"/>',
					width:450,
					height:230,
...
<body>
	<div class="easyui-layout" fit="true">
		<div region="north" border="false">
			<div class="subtitle">物资出库单管理</div>
			<div class="toolbar">
		...
		<div region="center" border="false">
			<table id="dg-bills" 
					url="<c:url value='/stock/outStock/getItems'/>"
				...
				<thead>
					<tr>
						...
						<th field="depotName" width="60"">出库库房</th>
						<th field="remark" width="100"">备注</th>
						<th field="billCount" width="60" align="right">出库数量</th>
						<th field="billCost" width="80" align="right" formatter="formatDecimal">出库金额</th>
	...
	<div id="dlg-bill" class="easyui-dialog" title="出库单" style="width:800px;height:410px;position:relative" closed="true">
	</div>
</body>