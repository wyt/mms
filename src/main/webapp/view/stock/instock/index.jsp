...
<head>
	<script type="text/javascript" src="<c:url value='/resources/js/jquery.combointercourse.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/resources/js/jquery.billgrid.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/resources/js/jquery.detailgrid.js'/>"></script>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#dg-bills').billgrid({
				createUrl:'<c:url value="/stock/instock/create.mvc"/>',
				editUrl:'<c:url value="/stock/instock/edit.mvc"/>',
				destroyUrl:'<c:url value="/stock/inStock/destroy"/>',
				query:{
					title:'查询入库单',
					form:'<c:url value="/view/stock/instock/_query.jsp"/>',
					width:450,
					height:230,
...
<body>
	<div class="easyui-layout" fit="true">
		<div region="north" border="false">
			<div class="subtitle">物资入库单管理</div>
			<div class="toolbar">
				<table cellpadding="0" cellspacing="0" style="width:100%">
					<tr>
						...
						<td style="text-align:right">
							<input id="q" class="easyui-searchbox" prompt="按单据编号查询" searcher="normalQuery"></input>
	...
	<div id="dlg-bill" class="easyui-dialog" title="入库单" style="width:800px;height:410px;position:relative" closed="true"></div>
</body>