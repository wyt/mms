...
public class BarCodeServlet extends HttpServlet {
    ...
    private BarCode getChart(HttpServletRequest httpservletrequest) {
        if (barcode == null) barcode = new BarCode();
        try {
    ...
    public void setParameter(String s, String s1) {
        if (s1 != null) if (s.equals("code"))
        ...
        else if (s.equals("barType")) if (s1.equalsIgnoreCase("CODE39"))
            barcode.barType = 0;
            ...
            barcode.barType = 16;
        else if (s1.equalsIgnoreCase("UCC128")) barcode.barType = 17;
    }
        ...
        try {
            ...
            if (barcode1.autoSize) {
                BufferedImage bufferedimage =
                        new BufferedImage(barcode1.getSize().width, barcode1.getSize().height, 13);
            ...
            BufferedImage bufferedimage1 =
                    new BufferedImage(barcode1.getSize().width, barcode1.getSize().height, 1);
            ...
            JPEGEncodeParam jpegencodeparam =
                    jpegimageencoder.getDefaultJPEGEncodeParam(bufferedimage1);
    ...
    private Font convertFont(String s) {
        ...
        if (s2.trim().toUpperCase().equals("PLAIN"))
            ...
            byte0 = 1;
        else if (s2.trim().toUpperCase().equals("ITALIC")) byte0 = 2;
    ...
    private Color convertColor(String s) {
        ...
        if (s.trim().toUpperCase().equals("RED"))
            ...
            color = Color.white;
        else if (s.trim().toUpperCase().equals("YELLOW")) color = Color.yellow;
        return color;
    }
}
